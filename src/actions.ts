export type ActionMenuName = 'File' | 'Edit' | 'Layer' | 'View' | 'Select' | 'Filter' | 'Tools' | 'Generators' | 'Help';
...
export class ActionRegistry {
  ...
  menus(): ActionMenu[] {
    ...
    const menus: ActionMenuName[] = ['File', 'Edit', 'Layer', 'View', 'Select', 'Filter', 'Tools', 'Generators', 'Help'];
