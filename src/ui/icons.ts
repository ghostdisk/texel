...
export type IconName = 'brush' | 'clone-stamp' | 'healing-brush' | 'rectangle' | 'ellipse' | 'freehand-lasso' | 'polygon-lasso' | 'crop' | 'transform' | 'eyedropper' | 'selection' | 'eraser' | 'generate' | 'remove' |
