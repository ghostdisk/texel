...
Texel is a fast desktop image editor built around the GPU. Its goal is to make everyday image editing responsive, keep filters editable and real-time, and treat AI generation and editing as first-class parts of the workflow.
